...
//default email from
$config['from_mail'] = 'noreply@jafra.co.id';
$config['from_name'] = 'HR_STARLINE Indonesia';
$config['subject_prefix'] = '[Leave] ';
...
$config['default_timezone'] = 'Asia/Jakarta';//'Europe/Paris';
