...
$sheet->setCellValue('G1', lang('requests_index_thead_cause'));
$sheet->setCellValue('H1', lang('requests_index_thead_status'));
...
foreach ($rows as $row) {
    ...
    $sheet->setCellValue('G' . $line, $row['cause']);
    $sheet->setCellValue('H' . $line, lang($row['status_name']));
    $line++;
}
//Autofit
